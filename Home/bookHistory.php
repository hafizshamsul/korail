                    ...
                    <div class="row" height="100%">
                        <div class="col-10" style="margin:0 auto; padding:19px 19px 19px 0; overflow:hidden; z-index:8998">
                            <?php
                                ...
                                echo"<form class='form-inline' action='bookHistory.php' method='post' style='float:right'>
                                        <input class='form-control' name='searchtext' type='text' placeholder='Search' aria-label='Search' style='margin: 10px 6px 6px 0'>
                                        <button type='submit' class='btn' name='update' style='margin-top: 6px'><i class='fas fa-search' aria-hidden='true'></i></button>
                                    </form>";
                                ...
                                echo"<table id='table' border='0' class='table' style='font-size:13px; table-layout:fixed; word-wrap:break-word; background-color:white; margin-left:6px; padding:0; max-width:none; box-shadow: 0 1px 6px 0 rgba(0, 0, 0, 0.05), 0 1px 6px 0 rgba(0, 0, 0, 0.05)'>";
                                    ...
                                    echo"<tr>";
                                    echo"<th>#</th>";
                                    echo"<th onclick='sortTable(1)'>Origin</th>";
                                    echo"<th onclick='sortTable(2)'>Destination</th>";
                                    echo"<th>Category</th>";
                                    echo"<th>Type</th>";
                                    echo"<th onclick='sortTable(5)'>Quantity</th>";
                                    echo"<th onclick='sortTable(6)'>Total Price</th>";
                                    echo"<th onclick='sortTable(7)'>Purchased Date</th>";
                                    echo"</tr>";
                                    echo"</thead>";
                                 ...
                                 if(isset($_POST['update'])){
                                    ...
                                    include("include_secure/dbconnect.inc");
                                    include("includes/dbcheck_connection.inc");
                                    $sql = "Select * from tickets where UserId=$userid and StartPoint like '%$search%' or UserId=$userid and EndPoint like '%$search%'";
                                    ...
                                    echo"<td align='center'>".$wayType."</td>";
                                    echo"<td align='center'>".$quantity."</td>";
                                    echo"<td align='center'>₩ ".number_format($totalPrice,2)."</td>";
                                    echo"<td align='center'>".$dateOfPurchase."</td>";
                                    echo"</tr>";
                                } } }else{
